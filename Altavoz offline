    ...
    <script>
        ...
        volumeSlider.addEventListener('input', function() {
            ...
            if (gainNode && audioContext) {
                // Curva de ganancia más suave y lineal para evitar saturación
        ...
        // Service Worker (para PWA y offline) - ¡Recordá crear el archivo sw.js!
